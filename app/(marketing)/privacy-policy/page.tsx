      ...
      <Prose>
        <div className="pb-4">
          <div className="subsection">
            ...
            <p>
              <em className="font-medium">
                ...
                uses, and discloses information about you. This Privacy Policy applies when you use
                our website, Balancer Protocol user-interface or application and other online
          ...
          <div className="subsection">
            ...
            <p>
              We do not typically request, collect or use personal information from you except under
              limited circumstances as described herein. With the exception of your wallet address,
              there is no reason for you to provide personal information when you use the UI. Your
              use of the UI will not be customized and this policy reflects that practice.
            </p>
            <p>
            ...
            <ul>
              <li>
                ...
                about the device and network you use, such as your hardware model, operating system
                version, mobile network, browser type, IP address and app version. We do not
                typically, but we may, also collect information about your activity on the UI, such
              ...
              <li>
                ...
                collect information about you; however, third parties we rely on may do so. Cookies
                are small data files stored on your hard drive or in device memory that help us
                improve the UI and your experience, see which areas and features of the UI are
                popular, and count visits. Web beacons (also known as “pixel tags” or “clear GIFs”)
                are electronic images that we use on the UI to help deliver cookies, count visits,
                and understand usage and campaign effectiveness. For more information about cookies
                and how to disable them, see our <Link href="cookies-policy">Cookies policy</Link>{' '}
            ...
            <p>
              ...
              providers. Your wallet and IP address is accessible to Balancer and its vendor(s). We
          ...
          <div className="subsection">
            ...
            <p>
              ...
              the UI for your use. However, we reserve the ability to use information we collect to
              provide, maintain, administer and/or improve the UI. We may also use the information
              we collect to:
            </p>
            <ul>
              ...
              <li>
                ...
                fraudulent, or illegal activity and protect the rights and property of Balancer and
                others;
              </li>
              ...
              <li>
                For other reasonable internal use or uses aligned with your relationship with us and
                the context in which we collected the information.
              </li>
            </ul>
          </div>
          <div className="subsection">
            ...
            <p>
              ...
              may share that information in the following circumstances or as otherwise described in
              this policy:
            </p>
            <ul>
              <li>
                We share personal information with vendors, service providers, and consultants that
                need access to personal information in order to perform services for us, such as
                transaction monitoring, data management, fraud prevention, customer service and
              ...
              <li>
                ...
                with our user agreements or policies, if we believe that you have violated the law,
                or if we believe it is necessary to protect the rights, property, and safety of
                Balancer, the Balancer ecosystem, the public, or others.
              </li>
              <li>
              ...
              <li>
                ...
                concerning, merger, sale of company assets, financing, bankruptcy, business closure,
                or acquisition of all or a portion of our assets. Additionally, as part of such an
                event, we may transfer or sell personal information to a third party. We will
                provide notice to you on our UI of any such sharing to a third party and any choices
                you may have regarding the sharing of your personal information.
              </li>
              <li>
                ...
                located in a jurisdiction where such sharing requires your permission, we will only
                share such information with your consent. If you decide you no longer wish to
                receive these promotional communications, please follow the instructions provided in
          ...
          <div className="subsection">
            ...
            <p>
              We do not work with third parties to serve ads to you as part of customized campaigns
              on the UI or third-party UIs.
            </p>
          </div>
          <div className="subsection">
            ...
            <p>
              ...
              jurisdiction. We will take steps to ensure that your personal information receives an
          ...
          <div className="subsection">
            ...
            <p>
              ...
              categories of personal information: identifiers, internet or other electronic network
              activity information and inferences. For details about the data points we collect and
              the categories of sources of such collection, please see the Collection of Information
              section above. We collect personal information for the purposes described in the Use
              of Information section above. In the preceding 12 months, we have disclosed the
              following categories of personal information for business purposes to the following
              ...
              <tr>
                ...
                <td>
                  ...
                  <p>
                    ...
                    connect a wallet to our UI (all other user information like IP addresses, device
                    identifiers and location are not shared). The code for the UI is open source,
                    and can be reviewed by anyone at any time.
                  </p>
                </td>
              </tr>
              <tr>
            ...
            <p>
              ...
              disclose, and sell, (2) request deletion of your personal information, (3) opt out of
              any “sales” of your personal information that may be occurring, and (4) not be
              ...
              you have provided such agent with a power of attorney or that the agent otherwise has
              valid written authority to submit requests to exercise rights on your behalf. If you
              are an authorized agent seeking to make a request, please contact us.
            </p>
            ...
            <p>
              Our Services do not respond to “Do Not Track” signals communicated by your browser. We
              do not knowingly retain or sell tracking information collected about your online
          ...
          <div className="subsection">
            ...
            <ul>
              <li>
                To perform our responsibilities under our contract with you (e.g., providing access
                to the UI you requested).
              </li>
              <li>
            ...
            <p>
              ...
              data we hold about you and to receive your data in a portable format, the right to ask
              that your personal data be corrected or erased, and the right to object to, or request
              that we restrict, certain processing. Balancer does not typically hold or store such
              personal data.
            </p>
          </div>
          <div>
