...
export type QuerySorGetSwapsArgs = {
  chain?: InputMaybe<GqlChain>;
  graphTraversalConfig?: InputMaybe<GqlGraphTraversalConfigInput>;
  swapAmount: Scalars['BigDecimal']['input'];
  swapOptions: GqlSorSwapOptionsInput;
  swapType: GqlSorSwapType;
  tokenIn: Scalars['String']['input'];
...
export type GetPoolQuery = { __typename: 'Query', pool: { __typename: 'GqlPoolElement', unitSeconds: string, principalToken: string, baseToken: string, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolGyro', alpha: string, beta: string, type: string, nestingType: GqlPoolNestingType, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } } | { __typename: 'GqlPoolTokenPhantomStable', id: string, index: number, name: string, symbol: string, balance: string, address: string, weight?: string | null, priceRate: string, decimals: number, totalBalance: string, pool: { __typename: 'GqlPoolPhantomStableNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, totalShares: string, totalLiquidity: string, nestingType: GqlPoolNestingType, swapFee: string, amp: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } }> } }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolLinear', mainIndex: number, wrappedIndex: number, lowerTarget: string, upperTarget: string, bptPriceRate: string, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolLiquidityBootstrapping', name: string, nestingType: GqlPoolNestingType, id: string, address: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } } | { __typename: 'GqlPoolTokenPhantomStable', id: string, index: number, name: string, symbol: string, balance: string, address: string, weight?: string | null, priceRate: string, decimals: number, totalBalance: string, pool: { __typename: 'GqlPoolPhantomStableNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, totalShares: string, totalLiquidity: string, nestingType: GqlPoolNestingType, swapFee: string, amp: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } }> } }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolMetaStable', amp: string, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolPhantomStable', amp: string, nestingType: GqlPoolNestingType, bptPriceRate: string, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, name: string, type: string, version: number, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } } | { __typename: 'GqlPoolTokenPhantomStable', id: string, index: number, name: string, symbol: string, balance: string, address: string, weight?: string | null, priceRate: string, decimals: number, totalBalance: string, pool: { __typename: 'GqlPoolPhantomStableNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, totalShares: string, totalLiquidity: string, nestingType: GqlPoolNestingType, swapFee: string, amp: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } }> } }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolStable', amp: string, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } | { __typename: 'GqlPoolWeighted', nestingType: GqlPoolNestingType, id: string, address: string, name: string, version: number, owner: string, decimals: number, factory?: string | null, symbol: string, createTime: number, type: string, chain: GqlChain, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } } | { __typename: 'GqlPoolTokenPhantomStable', id: string, index: number, name: string, symbol: string, balance: string, address: string, weight?: string | null, priceRate: string, decimals: number, totalBalance: string, pool: { __typename: 'GqlPoolPhantomStableNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, totalShares: string, totalLiquidity: string, nestingType: GqlPoolNestingType, swapFee: string, amp: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string } | { __typename: 'GqlPoolTokenLinear', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, mainTokenBalance: string, wrappedTokenBalance: string, totalMainTokenBalance: string, totalBalance: string, pool: { __typename: 'GqlPoolLinearNested', id: string, type: string, version: number, name: string, symbol: string, address: string, owner: string, factory?: string | null, createTime: number, wrappedIndex: number, mainIndex: number, upperTarget: string, lowerTarget: string, totalShares: string, totalLiquidity: string, bptPriceRate: string, tokens: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> } }> } }>, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapEnabled: boolean, totalLiquidity: string, totalLiquidity24hAgo: string, totalShares: string, totalShares24hAgo: string, fees24h: string, swapFee: string, volume24h: string, fees48h: string, volume48h: string, lifetimeVolume: string, lifetimeSwapFees: string, holdersCount: string, swapsCount: string, sharePriceAth: string, sharePriceAthTimestamp: number, sharePriceAtl: string, sharePriceAtlTimestamp: number, totalLiquidityAth: string, totalLiquidityAthTimestamp: number, totalLiquidityAtl: string, totalLiquidityAtlTimestamp: number, volume24hAth: string, volume24hAthTimestamp: number, volume24hAtl: string, volume24hAtlTimestamp: number, fees24hAth: string, fees24hAthTimestamp: number, fees24hAtl: string, fees24hAtlTimestamp: number, yieldCapture24h: string, yieldCapture48h: string, apr: { __typename: 'GqlPoolApr', hasRewardApr: boolean, swapApr: string, thirdPartyApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, nativeRewardApr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, items: Array<{ __typename: 'GqlBalancePoolAprItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string }, subItems?: Array<{ __typename: 'GqlBalancePoolAprSubItem', id: string, title: string, apr: { __typename: 'GqlPoolAprRange', min: string, max: string } | { __typename: 'GqlPoolAprTotal', total: string } }> | null }> } }, allTokens: Array<{ __typename: 'GqlPoolTokenExpanded', id: string, address: string, name: string, symbol: string, decimals: number, isNested: boolean, isPhantomBpt: boolean, isMainToken: boolean }>, displayTokens: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string, nestedTokens?: Array<{ __typename: 'GqlPoolTokenDisplay', id: string, address: string, name: string, weight?: string | null, symbol: string }> | null }>, staking?: { __typename: 'GqlPoolStaking', id: string, type: GqlPoolStakingType, chain: GqlChain, address: string, gauge?: { __typename: 'GqlPoolStakingGauge', id: string, gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, workingSupply: string, otherGauges?: Array<{ __typename: 'GqlPoolStakingOtherGauge', gaugeAddress: string, version: number, status: GqlPoolStakingGaugeStatus, id: string, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, tokenAddress: string, rewardPerSecond: string }> }> | null, rewards: Array<{ __typename: 'GqlPoolStakingGaugeReward', id: string, rewardPerSecond: string, tokenAddress: string }> } | null } | null, investConfig: { __typename: 'GqlPoolInvestConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolInvestOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> }, withdrawConfig: { __typename: 'GqlPoolWithdrawConfig', singleAssetEnabled: boolean, proportionalEnabled: boolean, options: Array<{ __typename: 'GqlPoolWithdrawOption', poolTokenIndex: number, poolTokenAddress: string, tokenOptions: Array<{ __typename: 'GqlPoolToken', id: string, index: number, name: string, symbol: string, balance: string, address: string, priceRate: string, decimals: number, weight?: string | null, totalBalance: string }> }> } } };
...
export type GetSorSwapsQuery = { __typename: 'Query', swaps: { __typename: 'GqlSorGetSwapsResponse', tokenIn: string, tokenOut: string, swapAmount: string, swapAmountForSwaps?: string | null, returnAmount: string, returnAmountFromSwaps?: string | null, returnAmountConsideringFees: string, marketSp: string, tokenAddresses: Array<string>, swaps: Array<{ __typename: 'GqlSorSwap', amount: string, assetInIndex: number, assetOutIndex: number, poolId: string, userData: string }> } };
...
export const GetPoolJoinsExitsSwapsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPoolJoinsExitsSwaps"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"skip"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"poolId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"chainId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GqlChain"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"swaps"},"name":{"kind":"Name","value":"poolGetSwaps"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"skip"},"value":{"kind":"Variable","name":{"kind":"Name","value":"skip"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"poolIdIn"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"poolId"}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"chainIn"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"chainId"}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"poolId"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"tokenAmountIn"}},{"kind":"Field","name":{"kind":"Name","value":"tokenAmountOut"}},{"kind":"Field","name":{"kind":"Name","value":"tokenIn"}},{"kind":"Field","name":{"kind":"Name","value":"tokenOut"}},{"kind":"Field","name":{"kind":"Name","value":"tx"}},{"kind":"Field","name":{"kind":"Name","value":"userAddress"}},{"kind":"Field","name":{"kind":"Name","value":"valueUSD"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"joinExits"},"name":{"kind":"Name","value":"poolGetJoinExits"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"skip"},"value":{"kind":"Variable","name":{"kind":"Name","value":"skip"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"poolIdIn"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"poolId"}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"chainIn"},"value":{"kind":"ListValue","values":[{"kind":"Variable","name":{"kind":"Name","value":"chainId"}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"tx"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"poolId"}},{"kind":"Field","name":{"kind":"Name","value":"valueUSD"}},{"kind":"Field","name":{"kind":"Name","value":"amounts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}}]}}]}}]}}]} as unknown as DocumentNode<GetPoolJoinsExitsSwapsQuery, GetPoolJoinsExitsSwapsQueryVariables>;
...
export const GetSorSwapsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSorSwaps"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tokenIn"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tokenOut"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"swapType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GqlSorSwapType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"swapAmount"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BigDecimal"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"chain"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GqlChain"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"swapOptions"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GqlSorSwapOptionsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"swaps"},"name":{"kind":"Name","value":"sorGetSwaps"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tokenIn"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tokenIn"}}},{"kind":"Argument","name":{"kind":"Name","value":"tokenOut"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tokenOut"}}},{"kind":"Argument","name":{"kind":"Name","value":"swapType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"swapType"}}},{"kind":"Argument","name":{"kind":"Name","value":"swapAmount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"swapAmount"}}},{"kind":"Argument","name":{"kind":"Name","value":"chain"},"value":{"kind":"Variable","name":{"kind":"Name","value":"chain"}}},{"kind":"Argument","name":{"kind":"Name","value":"swapOptions"},"value":{"kind":"Variable","name":{"kind":"Name","value":"swapOptions"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tokenIn"}},{"kind":"Field","name":{"kind":"Name","value":"tokenOut"}},{"kind":"Field","name":{"kind":"Name","value":"swapAmount"}},{"kind":"Field","name":{"kind":"Name","value":"swapAmountForSwaps"}},{"kind":"Field","name":{"kind":"Name","value":"returnAmount"}},{"kind":"Field","name":{"kind":"Name","value":"returnAmountFromSwaps"}},{"kind":"Field","name":{"kind":"Name","value":"returnAmountConsideringFees"}},{"kind":"Field","name":{"kind":"Name","value":"marketSp"}},{"kind":"Field","name":{"kind":"Name","value":"swaps"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"assetInIndex"}},{"kind":"Field","name":{"kind":"Name","value":"assetOutIndex"}},{"kind":"Field","name":{"kind":"Name","value":"poolId"}},{"kind":"Field","name":{"kind":"Name","value":"userData"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tokenAddresses"}}]}}]}}]} as unknown as DocumentNode<GetSorSwapsQuery, GetSorSwapsQueryVariables>;