...
export type GetUserDataQuery = { __typename?: 'Query', balances: Array<{ __typename?: 'GqlUserPoolBalance', poolId: string, chain: GqlChain, tokenAddress: string, tokenPrice: number, totalBalance: string, stakedBalance: string, walletBalance: string }> };
