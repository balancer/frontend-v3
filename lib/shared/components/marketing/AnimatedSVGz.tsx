...
export const AnimatedSVGz: React.FC<AnimatedSVGzProps> = () => {
  ...
  const pathD: MotionValue<string> = useTransform(
    ...
    [0, 1],
    [
      'm 0 0 l 221.231 1.533 l 125.303 79.738 l 202.761 -66.069 l 127.581 -70.624 l 6.834 161.755 l 325.786 -107.078',
      'm 0 0 l 136.937 -57.701 l 129.859 27.339 l 93.407 107.076 l 127.581 -70.624 l 113.91 -68.347 l 200.484 59.234',
    ]
  )
