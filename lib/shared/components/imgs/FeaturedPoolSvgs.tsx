  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <stop offset="1" stop-color="#07A5FF" />
      </linearGradient>
      <linearGradient
        id="b"
        x1="116.01"
      ...
      >
        ...
        <stop offset="1" stop-color="#88ABCC" />
      </linearGradient>
    </defs>
  </svg>
)
  ...
  >
    ...
    <defs>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stop-color="#2AB9F7" />
        <stop offset="1" stop-color="#A85BF7" />
      </linearGradient>
      <linearGradient
        id="2c"
        x1="60"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stop-color="#E3F7B9" />
        <stop offset="1" stop-color="#A4DB2E" />
      </linearGradient>
    </defs>
  </svg>
)
  ...
  >
    ...
    <defs>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stop-color="#3868BE" />
        <stop offset="1" stop-color="#fff" />
      </linearGradient>
      <linearGradient id="3b" x1="95.5" y1="-98" x2="39" y2="105" gradientUnits="userSpaceOnUse">
        <stop stop-color="#B1CDEC" />
        <stop offset="1" stop-color="#3868BE" />
      </linearGradient>
    </defs>
  </svg>
)
