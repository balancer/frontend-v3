// TODO: replace with wagmi generated abi once vault v3 is deployed in all networks
export const balancerV3VaultAbi = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    name: 'getAggregateProtocolSwapFeeAmount',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    name: 'getAggregateProtocolYieldFeeAmount',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
    ...
    outputs: [
      {
        components: [
          {
            internalType: 'uint24',
            name: 'staticSwapFeePercentageUnscaled',
            type: 'uint24',
          },
          {
            internalType: 'uint24',
            name: 'aggregateProtocolSwapFeePercentageUnscaled',
            type: 'uint24',
          },
          {
            internalType: 'uint24',
            name: 'aggregateProtocolYieldFeePercentageUnscaled',
            type: 'uint24',
          },
          {
            internalType: 'uint24',
